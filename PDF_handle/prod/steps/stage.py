...
def build_companion_candidate(
    *,
    ...
    draft_seed = {
        ...
        "short_summary_he": combined_result.get("section_summary_he") or f"טיוטת ערך מ־{route['work_title']}.",
        "full_summary_he": combined_result.get("section_summary_he", ""),
        "practical_elements_he": combined_result.get("practical_elements_he", []),
        "symbolic_meaning_he": combined_result.get("symbolic_meaning_he", ""),
        "candidate_lesson_he": combined_result.get("candidate_lesson_he", ""),
        "tradition_notes_he": combined_result.get("tradition_notes_he", []),
        "caution_notes_he": combined_result.get("caution_notes_he", []),
            ...
            for section_index, section in enumerate(sections, start=1):
                ...
                for match in content_targets:
                    operation = build_degree_patch_operation(
                        ...
                        source_notes=[source_note],
                        section_summary_he=combined.get("section_summary_he", ""),
                        practical_elements_he=combined.get("practical_elements_he", []),
                        symbolic_meaning_he=combined.get("symbolic_meaning_he", ""),
                        candidate_lesson_he=combined.get("candidate_lesson_he", ""),
                        tradition_notes_he=combined.get("tradition_notes_he", []),
                        caution_notes_he=combined.get("caution_notes_he", []),
                    )
